...
{block name='article'}
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="bi bi-file-earmark-plus me-2"></i> {#add_page#}
        </h1>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body p-4">
            ...
            <form id="add_page_form" action="index.php?controller=Pages&action=add" method="post" class="validate_form add_form">
                        ...
                        <select class="form-select selectpicker" data-live-search="true" id="parent_select" name="id_parent" onchange="document.getElementById('parent_id').value = this.value;">
                            ...
                            {if isset($pagesSelect)}
                                {foreach $pagesSelect as $item}
                                    {* On ne filtre plus les parents incorrects car c'est une nouvelle page *}
                                    <option value="{$item.id_pages}" {if ($smarty.get.parent|default:0) == $item.id_pages}selected{/if}>
                            ...
                            <fieldset class="tab-pane {if $iso@first}show active{/if}" id="lang-{$id}">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-9">
                                        ...
                                        <input type="text" class="form-control" id="name_pages_{$id}" name="content[{$id}][name_pages]" value="" />
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-9">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="longname_pages_{$id}" name="content[{$id}][longname_pages]" value="" maxlength="125" />
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-9">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control bg-light" id="url_pages_{$id}" name="content[{$id}][url_pages]" value="" readonly placeholder="Généré automatiquement à partir du titre..." />

                                            <button class="btn btn-outline-secondary toggle-url-lock" type="button" data-target="url_pages_{$id}" title="Déverrouiller pour personnaliser">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="resume_pages_{$id}" name="content[{$id}][resume_pages]" rows="3"></textarea>
                                </div>

                                {* Contenu TinyMCE *}
                                <div class="mb-4">
                                    <label for="content_pages_{$id}" class="form-label fw-medium">{#content#} :</label>
                                    <textarea class="form-control mceEditor" id="content_pages_{$id}" name="content[{$id}][content_pages]" rows="10"></textarea>
                                </div>
                                        ...
                                        <div id="link_{$id}" class="accordion-collapse collapse" data-bs-parent="#advancedAccordion_{$id}">
                                            <div class="accordion-body bg-white border-top">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="link_label_pages_{$id}" name="content[{$id}][link_label_pages]" value="">
                                                </div>
                                                <div class="mb-2">
                                                    <label for="link_title_pages_{$id}" class="form-label">{#custom_link_title#} :</label>
                                                    <input type="text" class="form-control" id="link_title_pages_{$id}" name="content[{$id}][link_title_pages]" value="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div id="seo_{$id}" class="accordion-collapse collapse" data-bs-parent="#advancedAccordion_{$id}">
                                            <div class="accordion-body bg-white border-top">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control seo-counter" id="seo_title_pages_{$id}" name="content[{$id}][seo_title_pages]" data-target="#count-title-{$id}" data-max="70" value="">
                                                </div>
                                                <div class="mb-2">
                                                    ...
                                                    <textarea class="form-control seo-counter" id="seo_desc_pages_{$id}" name="content[{$id}][seo_desc_pages]" data-target="#count-desc-{$id}" data-max="180" rows="3"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="d-flex justify-content-end">
                    <button type="submit" name="action" value="add" class="btn btn-success px-5">
                        <i class="bi bi-plus-circle me-2"></i>{#add_page#}
                    </button>
                </div>
            </form>
