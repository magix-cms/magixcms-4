...
class Youtube {
    constructor(url, options = {}) {
        ...
        this.width = '';
        this.height = '';
        this.ratio = '16x9'; // Changé pour correspondre à BS5
        this.autoplay = false;
        this.related = false;
    ...
    createIframe(width = 750, height = 315) {
        // Suppression de la classe embed-responsive-item pour l'aperçu
    ...
    compiledHTML() {
        ...
        // Conversion des anciens ratios (si le formulaire renvoie '16by9') en ratios BS5 ('16x9')
        let bsRatio = this.ratio.replace('by', 'x');

        // Nouveau conteneur Bootstrap 5
        let html = '<div class="ratio ratio-'+bsRatio+' mb-3">';

        html += '<picture class="ytb-video-preview" data-ytb=\''+JSON.stringify(params)+'\'>';

        // Correction : Remplacement de "size" par "sizes"
