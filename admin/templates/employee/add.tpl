...
{block name='head:title'}Ajouter un administrateur{/block}
...
{block name='article'}
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body p-4">
            <form action="index.php?controller=Employee&action=add" method="post" class="validate_form add_form">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" id="firstname_admin" name="firstname_admin" class="form-control" required>
                    </div>
                    <div class="col-md-3 mb-3">
                        <label for="lastname_admin" class="form-label fw-medium">Nom</label>
                        <input type="text" id="lastname_admin" name="lastname_admin" class="form-control" required>
                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="pseudo_admin" class="form-label fw-medium">Pseudo (Optionnel)</label>
                        <input type="text" id="pseudo_admin" name="pseudo_admin" class="form-control">
                    </div>
                </div>
                ...
                <div class="row mb-4 bg-light p-3 rounded border">
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="phone_admin" name="phone_admin" class="form-control" placeholder="ex: +32 4... / +33 6...">
                        </div>
                    </div>
                    <div class="col-md-8 mb-3">
                        <label for="address_admin" class="form-label fw-medium">Adresse complète</label>
                        <input type="text" id="address_admin" name="address_admin" class="form-control" placeholder="Numéro et rue...">
                    </div>
                    <div class="col-md-4 mb-3 mb-md-0">
                        <label for="postcode_admin" class="form-label fw-medium">Code postal</label>
                        <input type="text" id="postcode_admin" name="postcode_admin" class="form-control">
                    </div>
                    <div class="col-md-4 mb-3 mb-md-0">
                        <label for="city_admin" class="form-label fw-medium">Ville</label>
                        <input type="text" id="city_admin" name="city_admin" class="form-control">
                    </div>
                    <div class="col-md-4">
                        <label for="country_admin" class="form-label fw-medium">Pays</label>
                        <input type="text" id="country_admin" name="country_admin" class="form-control">
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    <div class="col-md-6 mb-3 mb-md-0">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" id="email_admin" name="email_admin" class="form-control" placeholder="jean.dupont@email.com" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <label for="passwd_admin" class="form-label fw-medium">Mot de passe <span class="text-danger">*</span></label>
                        <div class="input-group">
                            <span class="input-group-text bg-light"><i class="bi bi-key text-muted"></i></span>
                            <input type="password" id="passwd_admin" name="passwd_admin" class="form-control" required minlength="6">
                        </div>
                        <div class="form-text text-muted small mt-1">
                            <i class="bi bi-info-circle me-1"></i> Min. 6 caractères incluant : 1 majuscule, 1 minuscule, 1 chiffre et 1 caractère spécial.
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                        ...
                        <select name="id_role" id="id_role" class="form-select" required>
                            ...
                            {if isset($roles)}
                                {foreach $roles as $role}
                                    <option value="{$role.id_role}">{$role.role_name|capitalize}</option>
                                {/foreach}
                            {/if}
                        </select>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="form-check form-switch fs-5 mt-1">
                            ...
                            <input class="form-check-input" type="checkbox" role="switch" id="active_admin" name="active_admin" value="1" checked="checked">
